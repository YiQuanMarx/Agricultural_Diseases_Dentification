...
log_save_root_path = r"../../log/exp3/4batch"
model_save_path = r'../../log/exp3/4batch'
...
def main():
    ...
    log_train_loss=open(osp.join(log_save_root_path, "4batch_train_loss.txt"),
               'w')
    log_train_acc=open(osp.join(log_save_root_path, "4batch_train_acc.txt"),
               'w')
    log_val_loss=open(osp.join(log_save_root_path, "4batch_val_loss.txt"),
               'w')
    log_val_acc=open(osp.join(log_save_root_path, "4batch_val_acc.txt"),
               'w')
