...
log_save_root_path = r"../../log/exp2/RAdam"
model_save_path = r'../../log/exp2/RAdam'
...
def main():
    ...
    optimizer = optim.RAdam(params, lr=0.001,weight_decay=0.01)
    ...
    for epoch in range(epochs):         # 开始训练
        ...
        for step, data in enumerate(train_bar):     # 遍历数据集
            ...
            # loss = (loss - 0.29054024815559387).abs() + 0.29054024815559387 # This is it!
