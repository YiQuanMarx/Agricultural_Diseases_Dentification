...
log_save_root_path = r"../../log/exp4/0.23220568895339966"
model_save_path = r'../../log/exp4/0.23220568895339966'
...
def main():
    ...
    for epoch in range(epochs):         # 开始训练
        ...
        for step, data in enumerate(train_bar):     # 遍历数据集
            ...
            loss = (loss - 0.23220568895339966).abs() + 0.23220568895339966 # This is it!
