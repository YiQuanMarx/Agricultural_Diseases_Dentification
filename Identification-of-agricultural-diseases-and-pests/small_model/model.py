...
class Model(nn.Module):
    def __init__(self):
        ...
        self.weight = torch.load('/home/ll/python_daizuo/病虫害识别—细腻度/Bilinear_CNN-master/small_model/efficientnet-b3-5fb5a3c3.pth')
        ...
        self.fc = nn.Linear(in_features=2816,out_features=4)        # b3 : 2816  b7: 2560 + 1280 = 3840
