...
log_save_root_path = r"../../log/exp5/apple"
model_save_path=r'../../log/exp5/apple'
...
def main():
    ...
    image_path = os.path.join(r'../../data/other_data/plant_village')
    # pdb.set_trace()
   ...
   ## efv7
    ...
    net.fc=nn.Linear(in_features=1280,out_features=39)
