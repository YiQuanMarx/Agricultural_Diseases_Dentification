...
log_save_root_path = r"../log/mobile_v2"
model_save_path = r'../log/mobile_v2'
...
def main():
    ...
    for epoch in range(epochs):         # 开始训练
        ...
        log_train_loss=open(osp.join(log_save_root_path, time_for_file()+"_mobile_v2_train_loss.txt"),
               'w')
        log_train_acc=open(osp.join(log_save_root_path, time_for_file()+"_mobile_v2_train_acc.txt"),
               'w')
        log_val_loss=open(osp.join(log_save_root_path, time_for_file()+"_mobile_v2_val_loss.txt"),
               'w')
        log_val_acc=open(osp.join(log_save_root_path, time_for_file()+"_mobile_v2_val_acc.txt"),
               'w')
