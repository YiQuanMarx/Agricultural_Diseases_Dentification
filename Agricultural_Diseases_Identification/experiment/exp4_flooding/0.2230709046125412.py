...
log_save_root_path = r"../../log/exp4/0.2230709046125412"
model_save_path = r'../../log/exp4/0.2230709046125412'
...
def main():
    ...
    for epoch in range(epochs):         # 开始训练
        ...
        for step, data in enumerate(train_bar):     # 遍历数据集
            ...
            loss = (loss - 0.2230709046125412).abs() + 0.2230709046125412 # This is it!
    ...
    log_min_loss=open(osp.join(log_save_root_path, "12batch_min_loss.txt"),
    'w')
    log_train_loss=open(osp.join(log_save_root_path, "12batch_train_loss.txt"),
               'w')
    log_train_acc=open(osp.join(log_save_root_path, "12batch_train_acc.txt"),
               'w')
    log_val_loss=open(osp.join(log_save_root_path, "12batch_val_loss.txt"),
               'w')
    log_val_acc=open(osp.join(log_save_root_path, "12batch_val_acc.txt"),
               'w')
